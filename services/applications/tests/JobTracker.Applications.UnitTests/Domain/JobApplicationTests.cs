...
public class JobApplicationTests
{
    ...
    {
        var app = JobApplication.Create("  Acme  ", "  Engineer  ", ApplicationStatus.Applied, ApplicationSource.LinkedIn);
    ...
    public void Create_throws_when_company_blank(string company)
    {
        var ex = Assert.Throws<DomainException>(() =>
            JobApplication.Create(company, "Engineer", ApplicationStatus.Applied, ApplicationSource.Other));
    ...
    public void Create_throws_when_position_blank()
        => Assert.Throws<DomainException>(() =>
            JobApplication.Create("Acme", " ", ApplicationStatus.Applied, ApplicationSource.Other));

    [Fact]
    public void ChangeStatus_updates_status_and_bumps_updatedAt()
    {
        var app = JobApplication.Create("Acme", "Engineer", ApplicationStatus.Applied, ApplicationSource.Other);
